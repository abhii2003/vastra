    ...
    return (
        <section id="contact">
            ...
            <div className="contactcard">
                <h1>Contact Us</h1>
                <div><input className="email" placeholder="your e-mail" /></div>
                <div><input className="message" placeholder="send us a lovely message..." /></div>
